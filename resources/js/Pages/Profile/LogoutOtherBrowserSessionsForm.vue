<template>
    <jet-action-section>
        ...
        <template #description>
            Administrează-ți sesiunile active pe alte browsere sau dispozitive.
        </template>

        <template #content>
            <div class="max-w-xl text-sm text-gray-600">
                Din motive de securitate, dacă este necesar te poți deloga de pe toate sesiunile utilizate până acum. Te rugăm să iei in calcul schimbarea parolei dacă nu regăsești un dispozitiv pe această listă, dar pe care te-ai autentificat.
            </div>
                    ...
                    <div class="ml-3">
                        ...
                        <div>
                            <div class="text-xs text-gray-500">
                                ...
                                <span v-else>Ultima dată activ {{ session.last_active }}</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="flex items-center mt-5">
                <jet-button @click.native="confirmLogout">
                    Deloghează-te de pe alte sesiuni
                </jet-button>
            ...
            <jet-dialog-modal :show="confirmingLogout" @close="closeModal">
                ...
                <template #content>
                    Te rugăm să îți introduci parola pentru a confirma că vrei să te deloghezi de pe alte sesiuni browser (de pe toate alte dispozitive).
                ...
                <template #footer>
                    ...
                    <jet-button class="ml-2" @click.native="logoutOtherBrowserSessions" :class="{ 'opacity-25': form.processing }" :disabled="form.processing">
                        Deloghează-mă de pe alte sesiuni
                    </jet-button>
                </template>
            </jet-dialog-modal>
        </template>
