            ...
            <nav class="bg-white border-b border-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <jet-nav-link v-if="$page.props.user.check['general users']" :href="route('admin.users')" :active="route().current('admin.users')">
                                    Utilizatori
                                </jet-nav-link>
                                <jet-nav-link v-if="$page.props.user.check['general logs']" :href="route('admin.logs')" :active="route().current('admin.logs')">
                                    Monitorizare
                                </jet-nav-link>
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        <jet-responsive-nav-link v-if="$page.props.user.check['general users']" :href="route('admin.users')" :active="route().current('admin.users')">
                            Utilizatori
                        </jet-responsive-nav-link>
                        <jet-responsive-nav-link v-if="$page.props.user.check['general logs']" :href="route('admin.logs')" :active="route().current('admin.logs')">
                            Monitorizare
                        </jet-responsive-nav-link>
